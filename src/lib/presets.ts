...
export const COMPONENT_VARIANTS: Record<string, ComponentVariant[]> = {
  ...
  testimonial: [
    {
      id: "3d-testimonial-deck",
      name: "3D Stack Carousel Deck",
      description: "3D interactive deck carousel with active center card, reviewer avatars, star ratings, and auto-rotation.",
      badge: "Featured",
      previewType: "floating",
      applyProps: {
        variant: "3d-testimonial-deck",
        heading: "Loved by Innovators & Builders",
        subheading: "Hear from thousands of creators shipping web applications with visual builder tools.",
        items: [
          {
            quote: "“This builder completely transformed our agency workflow. We ship pixel-perfect client sites in hours instead of weeks.”",
    ...
    {
      id: "bento-testimonial-grid",
      name: "Modern Bento Grid Reviews",
      description: "Asymmetric Bento grid layout with customer quotes, star ratings, and company badges.",
      badge: "Popular",
      previewType: "grid",
      applyProps: {
        variant: "bento-testimonial-grid",
        heading: "What Our Customers Say",
        subheading: "Trusted by founders, lead engineers, and digital agencies worldwide.",
        items: [
          {
            quote: "“We cut our landing page development cycles by 80%. The real-time OKLCH theme editor and drag & drop blocks are unmatched.”",
            authorName: "Sophia Martinez",
            authorRole: "VP of Design, Apex Cloud",
            avatarUrl: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&q=80",
            rating: 5,
            companyLogo: "APEX CLOUD",
            metricTag: "Verified Enterprise",
          },
          {
            quote: "“The best visual canvas we have ever used for high-converting marketing pages.”",
            authorName: "David Kim",
            authorRole: "Growth Lead, TechPulse",
            avatarUrl: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&q=80",
            rating: 5,
          },
          {
            quote: "“Effortless publishing with zero setup overhead. The responsive device viewports are crisp.”",
            authorName: "Jessica Lee",
            authorRole: "Co-Founder, StudioNine",
    ...
    {
      id: "spotlight-testimonial-hero",
      name: "Single High-Impact Quote Hero",
      description: "Minimalist spotlight quote layout with big quote typography, reviewer avatar, and key metric badge.",
      badge: "Minimal",
      previewType: "centered",
      applyProps: {
        variant: "spotlight-testimonial-hero",
        quote: "“CraftSite allowed us to launch 12 high-converting landing pages in a single month. The speed, aesthetics, and reliability are unmatched.”",
        authorName: "David Sterling",
        authorRole: "Chief Marketing Officer, HyperScale Inc.",
        avatarUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80",
        rating: 5,
        metricTag: "+240% Growth in Q3",
        companyLogo: "HYPERSCALE",
      },
      applyStyle: {
        backgroundColor: "transparent",
        textColor: "#0f172a",
    ...
    {
      id: "wall-of-love-testimonials",
      name: "Wall of Love Grid Cards",
      description: "Clean multi-column review card grid showing customer quotes, avatar photos, star ratings, and timestamps.",
      badge: "Wall of Love",
      previewType: "grid",
      applyProps: {
        variant: "wall-of-love-testimonials",
        heading: "Wall of Love",
        subheading: "Real feedback from real creators building on our visual web engine.",
        items: [
          {
            quote: "“Cannot imagine launching web products without this tool. It's fast, flexible, and visually incredible!”",
            authorName: "Michael Chang",
            authorHandle: "@mchang_dev",
            avatarUrl: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&q=80",
            rating: 5,
            date: "2 days ago",
          },
          {
            quote: "“The preset templates and 3D deck cards gave our campaign page an instant 10/10 visual upgrade.”",
            authorName: "Rachel Adams",
            authorHandle: "@rachel_ui",
            avatarUrl: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&q=80",
            rating: 5,
            date: "1 week ago",
          },
          {
            quote: "“Instant cloud deployment and responsive device testing built right into the browser. Brilliant work!”",
    ...
    {
      id: "split-story-testimonial",
      name: "Split Case Study & Video Story",
      description: "2-Column layout featuring video/case study preview card on left and customer quote story on right.",
      badge: "Story",
      previewType: "split",
      applyProps: {
        variant: "split-story-testimonial",
        heading: "Customer Success Story",
        subheading: "How ScaleVenture unlocked 3.4x faster production releases with visual builder blocks.",
        quote: "“We replaced complex manual frontend boilerplate with modular visual sections. Our conversion rate skyrocketed overnight.”",
        authorName: "Amara Okonkwo",
        authorRole: "Director of Digital Strategy, ScaleVenture",
        avatarUrl: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80",
        rating: 5,
        metricTag: "3.4x Faster Shipping",
        videoPreviewUrl: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&q=80",
      },
      applyStyle: {
        backgroundColor: "transparent",
        textColor: "#0f172a",
