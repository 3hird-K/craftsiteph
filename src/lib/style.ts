...
export function themeVars(theme: SiteTheme): CSSProperties {
  return {
    ...
    ["--heading-font" as string]: theme.headingFontFamily || theme.fontFamily,
    ["--heading-color" as string]: theme.headingColor || theme.textColor,
    ["--heading-weight" as string]: theme.headingWeight || "800",
    ["--heading-transform" as string]: theme.headingTransform || "none",
    ["--body-font" as string]: theme.bodyFontFamily || theme.fontFamily,
    ["--body-color" as string]: theme.bodyColor || theme.textColor,
    ["--body-size" as string]: theme.bodyFontSize || "16px",
    ["--body-line-height" as string]: theme.bodyLineHeight || "1.6",
